...
import net.sourcebot.module.tags.TagHandler.Tag
...
class TagsCommand(
    ...
    private inner class TagsCreateCommand : Command() {
        ...
        override fun execute(message: Message, args: Arguments): Alert {
            ...
            val existing = tagHandler.getTag(name)
            ...
            tagHandler.createTag(name, content, message.author.id)
    ...
    private inner class TagsDeleteCommand : Command() {
        ...
        override fun execute(message: Message, args: Arguments): Alert {
            ...
            tagHandler.getTag(name) ?: return NoSuchTagAlert(name)
            tagHandler.deleteTag(name)
    ...
    private inner class TagsEditCommand : Command() {
        ...
        override fun execute(message: Message, args: Arguments): Alert {
            ...
            val tag = tagHandler.getTag(name) ?: return NoSuchTagAlert(name)
