...
class BanCommand : ModerationCommand(
    ...
    override fun execute(message: Message, args: Arguments): Alert {
        ...
        return SuccessAlert(
            "Ban Success",
            "Banned ${String.format("%#s", target)}: $reason"
        )
    }
}
...
class KickCommand : ModerationCommand(
    ...
    override fun execute(message: Message, args: Arguments): Alert {
        ...
        return SuccessAlert(
            "Kick Success",
            "Kicked ${String.format("%#s", target)}: $reason"
        )
    }
}
...
class MuteCommand : ModerationCommand(
    ...
    override fun execute(message: Message, args: Arguments): Alert {
        ...
        return SuccessAlert(
            "Mute Success",
            "Muted ${String.format("%#s", target)} for $duration: $reason"
        )
    }
}
...
class TempbanCommand : ModerationCommand(
    ...
    override fun execute(message: Message, args: Arguments): Alert {
        ...
        return SuccessAlert(
            "Tempban Success",
            "Tempbanned ${String.format("%#s", target)} for $duration: $reason"
        )
    }
}